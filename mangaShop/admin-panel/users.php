...
<table id="sorted" class="table table-striped table-bordered">
	...
	?>
		<tr>
			...
			<td><?php echo $userss['contact'] ?></td>
			<td><?php echo $userss['city'] ?></td>
			...
			<td><a href="edit-users.php?act=delete&id=<?php echo $userss['id'] ?>"><i class="glyphicon glyphicon-trash"></i></a></td>
		</tr>
	<?php endforeach; ?>
</table>
