				...
				<form method="post" action="save.php" enctype='multipart/form-data'>
					<fieldset>
						...
						<input name="act" type="hidden" value="<?=$act?>">
							...
							<label>Contact</label>
							<input class="form-control" type="text" name="contact" value="<?=$users['contact']?>" /><br>
							
							<label>City</label>
							<input class="form-control" type="text" name="city" value="<?=$users['city']?>" /><br>
							
							<label>Address</label>
							<input class="form-control" type="text" name="address" value="<?=$users['address']?>" /><br>
							<br>
